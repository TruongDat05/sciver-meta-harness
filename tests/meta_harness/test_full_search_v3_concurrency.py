...
from meta_harness.full_search_v3_concurrency import (
...
def _executor(tmp_path, factory, *, maximum=2, cache=None):
    return FullSearchV3RequestExecutor(
        cache=cache or FullSearchV3SearchCache(tmp_path / "cache"),
...
class _NotifyingProcessCache(FullSearchV3SearchCache):
...
class _CountingCache(FullSearchV3SearchCache):
